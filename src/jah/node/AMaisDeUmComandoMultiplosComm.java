...
public final class AMaisDeUmComandoMultiplosComm extends PMultiplosComm
{
    private PComm _comm_;
    private PMultiplosComm _multiplosComm_;

    public AMaisDeUmComandoMultiplosComm()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMaisDeUmComandoMultiplosComm(
    ...
    {
        ((Analysis) sw).caseAMaisDeUmComandoMultiplosComm(this);
    }
