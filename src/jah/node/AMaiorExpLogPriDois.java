...
public final class AMaiorExpLogPriDois extends PExpLogPriDois
{
    private TMaior _maior_;

    public AMaiorExpLogPriDois()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMaiorExpLogPriDois(
    ...
    {
        ((Analysis) sw).caseAMaiorExpLogPriDois(this);
    }
