...
public final class AMenorExpLogPriDois extends PExpLogPriDois
{
    private TMenor _menor_;

    public AMenorExpLogPriDois()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMenorExpLogPriDois(
    ...
    {
        ((Analysis) sw).caseAMenorExpLogPriDois(this);
    }
