...
public final class AExpSomaExpExpAritmetica extends PExpAritmetica
{
    private PExp _exp_;
    private TSoma _soma_;
    private PPosExp _posExp_;

    public AExpSomaExpExpAritmetica()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AExpSomaExpExpAritmetica(
    ...
    {
        ((Analysis) sw).caseAExpSomaExpExpAritmetica(this);
    }
