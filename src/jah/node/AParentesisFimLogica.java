...
public final class AParentesisFimLogica extends PFimLogica
{
    ...
    public Object clone()
    {
        return new AParentesisFimLogica(
    ...
    {
        ((Analysis) sw).caseAParentesisFimLogica(this);
    }
