...
public final class AApenasUmComandoMultiplosComm extends PMultiplosComm
{
    private PComm _comm_;

    public AApenasUmComandoMultiplosComm()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AApenasUmComandoMultiplosComm(
    ...
    {
        ((Analysis) sw).caseAApenasUmComandoMultiplosComm(this);
    }
