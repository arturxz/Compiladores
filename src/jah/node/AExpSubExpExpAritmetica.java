...
public final class AExpSubExpExpAritmetica extends PExpAritmetica
{
    private PExp _exp_;
    private TSub _sub_;
    private PPosExp _posExp_;

    public AExpSubExpExpAritmetica()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AExpSubExpExpAritmetica(
    ...
    {
        ((Analysis) sw).caseAExpSubExpExpAritmetica(this);
    }
