...
public final class AExpDivExpExpAritmetica extends PExpAritmetica
{
    private PExp _exp_;
    private TDiv _div_;
    private PPosExp _posExp_;

    public AExpDivExpExpAritmetica()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AExpDivExpExpAritmetica(
    ...
    {
        ((Analysis) sw).caseAExpDivExpExpAritmetica(this);
    }
