...
public final class AExpEntreParentesisExpAritmetica extends PExpAritmetica
{
    private TAbreParentesis _abreParentesis_;
    private PExp _exp_;
    private TFechaParentesis _fechaParentesis_;

    public AExpEntreParentesisExpAritmetica()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AExpEntreParentesisExpAritmetica(
    ...
    {
        ((Analysis) sw).caseAExpEntreParentesisExpAritmetica(this);
    }
