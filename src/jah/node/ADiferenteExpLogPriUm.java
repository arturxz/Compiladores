...
public final class ADiferenteExpLogPriUm extends PExpLogPriUm
{
    private TDiferente _diferente_;

    public ADiferenteExpLogPriUm()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ADiferenteExpLogPriUm(
    ...
    {
        ((Analysis) sw).caseADiferenteExpLogPriUm(this);
    }
