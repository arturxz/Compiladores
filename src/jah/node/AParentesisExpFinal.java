...
public final class AParentesisExpFinal extends PExpFinal
{
    private TAbreParentesis _abreParentesis_;
    private PExp _exp_;
    private TFechaParentesis _fechaParentesis_;

    public AParentesisExpFinal()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AParentesisExpFinal(
    ...
    {
        ((Analysis) sw).caseAParentesisExpFinal(this);
    }
