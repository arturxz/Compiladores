...
public final class AExplogicaEntreParentesisExpLogica extends PExpLogica
{
    private TAbreParentesis _abreParentesis_;
    private PExpLogica _expLogica_;
    private TFechaParentesis _fechaParentesis_;

    public AExplogicaEntreParentesisExpLogica()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AExplogicaEntreParentesisExpLogica(
    ...
    {
        ((Analysis) sw).caseAExplogicaEntreParentesisExpLogica(this);
    }
