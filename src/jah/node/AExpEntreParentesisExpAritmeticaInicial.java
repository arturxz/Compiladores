...
public final class AExpEntreParentesisExpAritmeticaInicial extends PExpAritmeticaInicial
{
    private TAbreParentesis _abreParentesis_;
    private PExp _exp_;
    private TFechaParentesis _fechaParentesis_;

    public AExpEntreParentesisExpAritmeticaInicial()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AExpEntreParentesisExpAritmeticaInicial(
    ...
    {
        ((Analysis) sw).caseAExpEntreParentesisExpAritmeticaInicial(this);
    }
