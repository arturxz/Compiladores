...
public final class AMaiorigualExpLogPriDois extends PExpLogPriDois
{
    private TMaiorIgual _maiorIgual_;

    public AMaiorigualExpLogPriDois()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMaiorigualExpLogPriDois(
    ...
    {
        ((Analysis) sw).caseAMaiorigualExpLogPriDois(this);
    }
