...
public final class AComandoParaIteraComm extends PComm
{
    ...
    public Object clone()
    {
        return new AComandoParaIteraComm(
    ...
    {
        ((Analysis) sw).caseAComandoParaIteraComm(this);
    }
