...
public final class AMenorqLogPrecDois extends PLogPrecDois
{
    private PExp _exp_;
    private TMenorIgual _menorIgual_;
    private PTermo _termo_;

    public AMenorqLogPrecDois()
    {
        // Constructor
    }
    ...
    {
        ((Analysis) sw).caseAMenorqLogPrecDois(this);
    }
